...
from ...models.coupons_destroy_response_409 import CouponsDestroyResponse409
from ...models.coupons_destroy_response_412 import CouponsDestroyResponse412
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 409:
        response_409 = CouponsDestroyResponse409.from_dict(response.json())

        return response_409

    if response.status_code == 412:
        response_412 = CouponsDestroyResponse412.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | CouponsDestroyResponse400 | CouponsDestroyResponse401 | CouponsDestroyResponse403 | CouponsDestroyResponse404 | CouponsDestroyResponse409 | CouponsDestroyResponse412]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | CouponsDestroyResponse400 | CouponsDestroyResponse401 | CouponsDestroyResponse403 | CouponsDestroyResponse404 | CouponsDestroyResponse409 | CouponsDestroyResponse412
    """
