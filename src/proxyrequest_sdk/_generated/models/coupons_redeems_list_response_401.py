...
T = TypeVar("T", bound="CouponsRedeemsListResponse401")


@_attrs_define
class CouponsRedeemsListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_redeems_list_response_401 = cls(
            detail=detail,
        ...
        coupons_redeems_list_response_401.additional_properties = additional_properties
        return coupons_redeems_list_response_401
