...
T = TypeVar("T", bound="PaginatedNewsList")
...
class PaginatedNewsList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = News.from_dict(results_item_data)
        ...
        paginated_news_list.additional_properties = d
        return paginated_news_list
