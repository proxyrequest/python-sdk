...
T = TypeVar("T", bound="CouponsRedeemsListResponse403")


@_attrs_define
class CouponsRedeemsListResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_redeems_list_response_403 = cls(
            detail=detail,
        ...
        coupons_redeems_list_response_403.additional_properties = additional_properties
        return coupons_redeems_list_response_403
