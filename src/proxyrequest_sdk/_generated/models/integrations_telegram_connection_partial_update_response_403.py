...
T = TypeVar("T", bound="IntegrationsTelegramConnectionPartialUpdateResponse403")


@_attrs_define
class IntegrationsTelegramConnectionPartialUpdateResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integrations_telegram_connection_partial_update_response_403 = cls(
            detail=detail,
        ...
        integrations_telegram_connection_partial_update_response_403.additional_properties = (
            additional_properties
        )
        return integrations_telegram_connection_partial_update_response_403
