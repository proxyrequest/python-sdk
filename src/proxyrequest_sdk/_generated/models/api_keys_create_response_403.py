...
T = TypeVar("T", bound="ApiKeysCreateResponse403")


@_attrs_define
class ApiKeysCreateResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_keys_create_response_403 = cls(
            detail=detail,
        ...
        api_keys_create_response_403.additional_properties = additional_properties
        return api_keys_create_response_403
