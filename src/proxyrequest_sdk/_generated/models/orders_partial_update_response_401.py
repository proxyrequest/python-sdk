...
T = TypeVar("T", bound="OrdersPartialUpdateResponse401")


@_attrs_define
class OrdersPartialUpdateResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_partial_update_response_401 = cls(
            detail=detail,
        ...
        orders_partial_update_response_401.additional_properties = additional_properties
        return orders_partial_update_response_401
