...
T = TypeVar("T", bound="InvoicesRetrieveResponse401")


@_attrs_define
class InvoicesRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_retrieve_response_401 = cls(
            detail=detail,
        ...
        invoices_retrieve_response_401.additional_properties = additional_properties
        return invoices_retrieve_response_401
