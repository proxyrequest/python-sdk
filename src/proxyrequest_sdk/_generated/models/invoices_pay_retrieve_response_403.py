...
T = TypeVar("T", bound="InvoicesPayRetrieveResponse403")


@_attrs_define
class InvoicesPayRetrieveResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_pay_retrieve_response_403 = cls(
            detail=detail,
        ...
        invoices_pay_retrieve_response_403.additional_properties = additional_properties
        return invoices_pay_retrieve_response_403
