...
T = TypeVar("T", bound="CouponsCreateResponse409")


@_attrs_define
class CouponsCreateResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_create_response_409 = cls(
            detail=detail,
        ...
        coupons_create_response_409.additional_properties = additional_properties
        return coupons_create_response_409
