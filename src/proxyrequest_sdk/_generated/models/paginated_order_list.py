...
T = TypeVar("T", bound="PaginatedOrderList")


@_attrs_define
class PaginatedOrderList:
    count: int
    results: list[Order]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Order.from_dict(results_item_data)
        ...
        paginated_order_list.additional_properties = d
        return paginated_order_list
