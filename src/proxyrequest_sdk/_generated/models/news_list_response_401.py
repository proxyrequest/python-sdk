...
T = TypeVar("T", bound="NewsListResponse401")


@_attrs_define
class NewsListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        news_list_response_401.additional_properties = additional_properties
        return news_list_response_401
