...
T = TypeVar("T", bound="PackagesCommissionsListResponse401")


@_attrs_define
class PackagesCommissionsListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        packages_commissions_list_response_401 = cls(
            detail=detail,
        ...
        packages_commissions_list_response_401.additional_properties = additional_properties
        return packages_commissions_list_response_401
