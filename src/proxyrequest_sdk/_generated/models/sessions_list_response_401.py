...
T = TypeVar("T", bound="SessionsListResponse401")


@_attrs_define
class SessionsListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sessions_list_response_401 = cls(
            detail=detail,
        ...
        sessions_list_response_401.additional_properties = additional_properties
        return sessions_list_response_401
