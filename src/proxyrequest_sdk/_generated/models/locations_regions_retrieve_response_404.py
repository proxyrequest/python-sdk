...
T = TypeVar("T", bound="LocationsRegionsRetrieveResponse404")


@_attrs_define
class LocationsRegionsRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        locations_regions_retrieve_response_404 = cls(
            detail=detail,
        ...
        locations_regions_retrieve_response_404.additional_properties = additional_properties
        return locations_regions_retrieve_response_404
