...
T = TypeVar("T", bound="ApiKeysListResponse400")


@_attrs_define
class ApiKeysListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_keys_list_response_400 = cls(
            detail=detail,
        ...
        api_keys_list_response_400.additional_properties = additional_properties
        return api_keys_list_response_400
