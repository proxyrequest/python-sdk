...
T = TypeVar("T", bound="InvoicesPayRetrieveResponse400")


@_attrs_define
class InvoicesPayRetrieveResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_pay_retrieve_response_400 = cls(
            detail=detail,
        ...
        invoices_pay_retrieve_response_400.additional_properties = additional_properties
        return invoices_pay_retrieve_response_400
