...
T = TypeVar("T", bound="OrdersDestroyResponse401")


@_attrs_define
class OrdersDestroyResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_destroy_response_401 = cls(
            detail=detail,
        ...
        orders_destroy_response_401.additional_properties = additional_properties
        return orders_destroy_response_401
