...
T = TypeVar("T", bound="PackagesListResponse403")


@_attrs_define
class PackagesListResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        packages_list_response_403 = cls(
            detail=detail,
        ...
        packages_list_response_403.additional_properties = additional_properties
        return packages_list_response_403
