...
T = TypeVar("T", bound="OrdersListResponse403")


@_attrs_define
class OrdersListResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_list_response_403.additional_properties = additional_properties
        return orders_list_response_403
