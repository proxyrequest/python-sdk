...
T = TypeVar("T", bound="InvoicesListResponse401")


@_attrs_define
class InvoicesListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_list_response_401 = cls(
            detail=detail,
        ...
        invoices_list_response_401.additional_properties = additional_properties
        return invoices_list_response_401
