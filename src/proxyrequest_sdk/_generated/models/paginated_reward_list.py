...
T = TypeVar("T", bound="PaginatedRewardList")
...
class PaginatedRewardList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Reward.from_dict(results_item_data)
        ...
        paginated_reward_list.additional_properties = d
        return paginated_reward_list
