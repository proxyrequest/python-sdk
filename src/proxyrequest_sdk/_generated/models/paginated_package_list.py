...
T = TypeVar("T", bound="PaginatedPackageList")
...
class PaginatedPackageList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Package.from_dict(results_item_data)
        ...
        paginated_package_list.additional_properties = d
        return paginated_package_list
