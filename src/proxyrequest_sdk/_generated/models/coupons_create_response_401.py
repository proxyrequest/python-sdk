...
T = TypeVar("T", bound="CouponsCreateResponse401")


@_attrs_define
class CouponsCreateResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_create_response_401 = cls(
            detail=detail,
        ...
        coupons_create_response_401.additional_properties = additional_properties
        return coupons_create_response_401
