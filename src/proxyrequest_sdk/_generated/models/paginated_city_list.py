...
T = TypeVar("T", bound="PaginatedCityList")


@_attrs_define
class PaginatedCityList:
    count: int
    results: list[City]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = City.from_dict(results_item_data)
        ...
        paginated_city_list.additional_properties = d
        return paginated_city_list
