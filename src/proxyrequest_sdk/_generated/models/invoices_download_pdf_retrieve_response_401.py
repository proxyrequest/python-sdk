...
T = TypeVar("T", bound="InvoicesDownloadPdfRetrieveResponse401")


@_attrs_define
class InvoicesDownloadPdfRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_download_pdf_retrieve_response_401 = cls(
            detail=detail,
        ...
        invoices_download_pdf_retrieve_response_401.additional_properties = additional_properties
        return invoices_download_pdf_retrieve_response_401
