...
T = TypeVar("T", bound="ProxiesGenerateCreateResponse401")


@_attrs_define
class ProxiesGenerateCreateResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        proxies_generate_create_response_401 = cls(
            detail=detail,
        ...
        proxies_generate_create_response_401.additional_properties = additional_properties
        return proxies_generate_create_response_401
