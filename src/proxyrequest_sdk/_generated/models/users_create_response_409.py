...
T = TypeVar("T", bound="UsersCreateResponse409")


@_attrs_define
class UsersCreateResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_create_response_409.additional_properties = additional_properties
        return users_create_response_409
