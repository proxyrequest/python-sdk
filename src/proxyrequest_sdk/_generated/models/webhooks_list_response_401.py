...
T = TypeVar("T", bound="WebhooksListResponse401")


@_attrs_define
class WebhooksListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhooks_list_response_401 = cls(
            detail=detail,
        ...
        webhooks_list_response_401.additional_properties = additional_properties
        return webhooks_list_response_401
