...
T = TypeVar("T", bound="InvoicesPayRetrieveResponse401")


@_attrs_define
class InvoicesPayRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_pay_retrieve_response_401 = cls(
            detail=detail,
        ...
        invoices_pay_retrieve_response_401.additional_properties = additional_properties
        return invoices_pay_retrieve_response_401
