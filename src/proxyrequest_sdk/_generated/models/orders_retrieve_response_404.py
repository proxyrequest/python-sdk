...
T = TypeVar("T", bound="OrdersRetrieveResponse404")


@_attrs_define
class OrdersRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_retrieve_response_404 = cls(
            detail=detail,
        ...
        orders_retrieve_response_404.additional_properties = additional_properties
        return orders_retrieve_response_404
