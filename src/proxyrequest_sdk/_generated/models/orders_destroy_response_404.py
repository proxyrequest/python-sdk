...
T = TypeVar("T", bound="OrdersDestroyResponse404")


@_attrs_define
class OrdersDestroyResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_destroy_response_404 = cls(
            detail=detail,
        ...
        orders_destroy_response_404.additional_properties = additional_properties
        return orders_destroy_response_404
