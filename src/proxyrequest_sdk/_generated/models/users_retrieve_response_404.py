...
T = TypeVar("T", bound="UsersRetrieveResponse404")


@_attrs_define
class UsersRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_retrieve_response_404 = cls(
            detail=detail,
        ...
        users_retrieve_response_404.additional_properties = additional_properties
        return users_retrieve_response_404
