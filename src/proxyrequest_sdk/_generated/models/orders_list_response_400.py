...
T = TypeVar("T", bound="OrdersListResponse400")


@_attrs_define
class OrdersListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_list_response_400.additional_properties = additional_properties
        return orders_list_response_400
