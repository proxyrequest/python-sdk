...
T = TypeVar("T", bound="InvoicesDownloadPdfRetrieveResponse403")


@_attrs_define
class InvoicesDownloadPdfRetrieveResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_download_pdf_retrieve_response_403 = cls(
            detail=detail,
        ...
        invoices_download_pdf_retrieve_response_403.additional_properties = additional_properties
        return invoices_download_pdf_retrieve_response_403
