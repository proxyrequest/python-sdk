...
T = TypeVar("T", bound="UsersDestroyResponse404")


@_attrs_define
class UsersDestroyResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_destroy_response_404 = cls(
            detail=detail,
        ...
        users_destroy_response_404.additional_properties = additional_properties
        return users_destroy_response_404
