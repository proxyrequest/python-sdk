...
T = TypeVar("T", bound="AnalyticsOverallRetrieveResponse401")


@_attrs_define
class AnalyticsOverallRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        analytics_overall_retrieve_response_401 = cls(
            detail=detail,
        ...
        analytics_overall_retrieve_response_401.additional_properties = additional_properties
        return analytics_overall_retrieve_response_401
