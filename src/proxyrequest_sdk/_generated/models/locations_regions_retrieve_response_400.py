...
T = TypeVar("T", bound="LocationsRegionsRetrieveResponse400")


@_attrs_define
class LocationsRegionsRetrieveResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        locations_regions_retrieve_response_400 = cls(
            detail=detail,
        ...
        locations_regions_retrieve_response_400.additional_properties = additional_properties
        return locations_regions_retrieve_response_400
