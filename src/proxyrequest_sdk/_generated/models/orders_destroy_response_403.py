...
T = TypeVar("T", bound="OrdersDestroyResponse403")


@_attrs_define
class OrdersDestroyResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_destroy_response_403 = cls(
            detail=detail,
        ...
        orders_destroy_response_403.additional_properties = additional_properties
        return orders_destroy_response_403
