...
T = TypeVar("T", bound="IntegrationsTelegramConnectionDestroyResponse403")


@_attrs_define
class IntegrationsTelegramConnectionDestroyResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integrations_telegram_connection_destroy_response_403 = cls(
            detail=detail,
        ...
        integrations_telegram_connection_destroy_response_403.additional_properties = (
            additional_properties
        )
        return integrations_telegram_connection_destroy_response_403
