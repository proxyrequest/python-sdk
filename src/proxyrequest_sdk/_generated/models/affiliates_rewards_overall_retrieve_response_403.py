...
T = TypeVar("T", bound="AffiliatesRewardsOverallRetrieveResponse403")


@_attrs_define
class AffiliatesRewardsOverallRetrieveResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        affiliates_rewards_overall_retrieve_response_403 = cls(
            detail=detail,
        ...
        affiliates_rewards_overall_retrieve_response_403.additional_properties = (
            additional_properties
        )
        return affiliates_rewards_overall_retrieve_response_403
