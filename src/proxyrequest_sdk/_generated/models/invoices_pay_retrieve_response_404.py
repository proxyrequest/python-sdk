...
T = TypeVar("T", bound="InvoicesPayRetrieveResponse404")


@_attrs_define
class InvoicesPayRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_pay_retrieve_response_404 = cls(
            detail=detail,
        ...
        invoices_pay_retrieve_response_404.additional_properties = additional_properties
        return invoices_pay_retrieve_response_404
