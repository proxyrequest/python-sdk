...
T = TypeVar("T", bound="UsersListResponse400")


@_attrs_define
class UsersListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_list_response_400.additional_properties = additional_properties
        return users_list_response_400
