...
T = TypeVar("T", bound="CouponsCreateResponse400")


@_attrs_define
class CouponsCreateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_create_response_400 = cls(
            detail=detail,
        ...
        coupons_create_response_400.additional_properties = additional_properties
        return coupons_create_response_400
