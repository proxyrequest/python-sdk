...
T = TypeVar("T", bound="InvoicesRetrieveResponse404")


@_attrs_define
class InvoicesRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_retrieve_response_404 = cls(
            detail=detail,
        ...
        invoices_retrieve_response_404.additional_properties = additional_properties
        return invoices_retrieve_response_404
