...
T = TypeVar("T", bound="IntegrationsTelegramLinkConsumeCreateResponse400")


@_attrs_define
class IntegrationsTelegramLinkConsumeCreateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integrations_telegram_link_consume_create_response_400 = cls(
            detail=detail,
        ...
        integrations_telegram_link_consume_create_response_400.additional_properties = (
            additional_properties
        )
        return integrations_telegram_link_consume_create_response_400
