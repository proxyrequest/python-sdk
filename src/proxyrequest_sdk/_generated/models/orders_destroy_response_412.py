...
T = TypeVar("T", bound="OrdersDestroyResponse412")


@_attrs_define
class OrdersDestroyResponse412:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_destroy_response_412 = cls(
            detail=detail,
        ...
        orders_destroy_response_412.additional_properties = additional_properties
        return orders_destroy_response_412
