...
T = TypeVar("T", bound="IntegrationsTelegramConnectionRetrieveResponse403")


@_attrs_define
class IntegrationsTelegramConnectionRetrieveResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integrations_telegram_connection_retrieve_response_403 = cls(
            detail=detail,
        ...
        integrations_telegram_connection_retrieve_response_403.additional_properties = (
            additional_properties
        )
        return integrations_telegram_connection_retrieve_response_403
