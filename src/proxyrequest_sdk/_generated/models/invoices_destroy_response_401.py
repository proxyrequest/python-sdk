...
T = TypeVar("T", bound="InvoicesDestroyResponse401")


@_attrs_define
class InvoicesDestroyResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_destroy_response_401 = cls(
            detail=detail,
        ...
        invoices_destroy_response_401.additional_properties = additional_properties
        return invoices_destroy_response_401
