...
T = TypeVar("T", bound="PackagesListResponse401")


@_attrs_define
class PackagesListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        packages_list_response_401 = cls(
            detail=detail,
        ...
        packages_list_response_401.additional_properties = additional_properties
        return packages_list_response_401
