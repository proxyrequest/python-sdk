...
T = TypeVar("T", bound="ProxiesGenerateCreateResponse404")


@_attrs_define
class ProxiesGenerateCreateResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        proxies_generate_create_response_404 = cls(
            detail=detail,
        ...
        proxies_generate_create_response_404.additional_properties = additional_properties
        return proxies_generate_create_response_404
