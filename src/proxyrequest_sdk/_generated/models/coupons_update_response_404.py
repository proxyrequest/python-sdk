...
T = TypeVar("T", bound="CouponsUpdateResponse404")


@_attrs_define
class CouponsUpdateResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_update_response_404 = cls(
            detail=detail,
        ...
        coupons_update_response_404.additional_properties = additional_properties
        return coupons_update_response_404
