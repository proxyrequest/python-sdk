...
T = TypeVar("T", bound="InvoicesDestroyResponse404")


@_attrs_define
class InvoicesDestroyResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_destroy_response_404 = cls(
            detail=detail,
        ...
        invoices_destroy_response_404.additional_properties = additional_properties
        return invoices_destroy_response_404
