...
T = TypeVar("T", bound="WebhooksRetrieveResponse404")


@_attrs_define
class WebhooksRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhooks_retrieve_response_404 = cls(
            detail=detail,
        ...
        webhooks_retrieve_response_404.additional_properties = additional_properties
        return webhooks_retrieve_response_404
