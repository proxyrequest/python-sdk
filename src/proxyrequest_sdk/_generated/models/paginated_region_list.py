...
T = TypeVar("T", bound="PaginatedRegionList")
...
class PaginatedRegionList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Region.from_dict(results_item_data)
        ...
        paginated_region_list.additional_properties = d
        return paginated_region_list
