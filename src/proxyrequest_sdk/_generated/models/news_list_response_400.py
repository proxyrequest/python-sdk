...
T = TypeVar("T", bound="NewsListResponse400")


@_attrs_define
class NewsListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        news_list_response_400.additional_properties = additional_properties
        return news_list_response_400
