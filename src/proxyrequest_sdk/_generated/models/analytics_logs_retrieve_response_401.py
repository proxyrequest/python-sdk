...
T = TypeVar("T", bound="AnalyticsLogsRetrieveResponse401")


@_attrs_define
class AnalyticsLogsRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        analytics_logs_retrieve_response_401 = cls(
            detail=detail,
        ...
        analytics_logs_retrieve_response_401.additional_properties = additional_properties
        return analytics_logs_retrieve_response_401
