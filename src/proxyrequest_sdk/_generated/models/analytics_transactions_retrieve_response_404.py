...
T = TypeVar("T", bound="AnalyticsTransactionsRetrieveResponse404")


@_attrs_define
class AnalyticsTransactionsRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        analytics_transactions_retrieve_response_404 = cls(
            detail=detail,
        ...
        analytics_transactions_retrieve_response_404.additional_properties = additional_properties
        return analytics_transactions_retrieve_response_404
