...
T = TypeVar("T", bound="ApiKeysDestroyResponse409")


@_attrs_define
class ApiKeysDestroyResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_keys_destroy_response_409 = cls(
            detail=detail,
        ...
        api_keys_destroy_response_409.additional_properties = additional_properties
        return api_keys_destroy_response_409
