...
T = TypeVar("T", bound="InvoicesListResponse403")


@_attrs_define
class InvoicesListResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_list_response_403 = cls(
            detail=detail,
        ...
        invoices_list_response_403.additional_properties = additional_properties
        return invoices_list_response_403
