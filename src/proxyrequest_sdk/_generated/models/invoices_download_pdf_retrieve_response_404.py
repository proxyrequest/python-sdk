...
T = TypeVar("T", bound="InvoicesDownloadPdfRetrieveResponse404")


@_attrs_define
class InvoicesDownloadPdfRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_download_pdf_retrieve_response_404 = cls(
            detail=detail,
        ...
        invoices_download_pdf_retrieve_response_404.additional_properties = additional_properties
        return invoices_download_pdf_retrieve_response_404
