...
T = TypeVar("T", bound="PatchedCouponUpdateRequest")


@_attrs_define
class PatchedCouponUpdateRequest:
    ...
    type_: CouponTypeEnum | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: CouponTypeEnum | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = CouponTypeEnum(_type_)
        ...
        patched_coupon_update_request = cls(
            value=value,
            code=code,
        ...
        patched_coupon_update_request.additional_properties = d
        return patched_coupon_update_request
