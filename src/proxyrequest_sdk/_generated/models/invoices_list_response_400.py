...
T = TypeVar("T", bound="InvoicesListResponse400")


@_attrs_define
class InvoicesListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_list_response_400 = cls(
            detail=detail,
        ...
        invoices_list_response_400.additional_properties = additional_properties
        return invoices_list_response_400
