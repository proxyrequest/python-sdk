...
T = TypeVar("T", bound="UsersListResponse403")


@_attrs_define
class UsersListResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_list_response_403.additional_properties = additional_properties
        return users_list_response_403
