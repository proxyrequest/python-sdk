...
T = TypeVar("T", bound="UsersDestroyResponse401")


@_attrs_define
class UsersDestroyResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_destroy_response_401 = cls(
            detail=detail,
        ...
        users_destroy_response_401.additional_properties = additional_properties
        return users_destroy_response_401
