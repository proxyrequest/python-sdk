...
T = TypeVar("T", bound="OrdersRetrieveResponse400")


@_attrs_define
class OrdersRetrieveResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_retrieve_response_400 = cls(
            detail=detail,
        ...
        orders_retrieve_response_400.additional_properties = additional_properties
        return orders_retrieve_response_400
