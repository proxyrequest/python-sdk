...
T = TypeVar("T", bound="PaginatedContinentList")


@_attrs_define
class PaginatedContinentList:
    count: int
    results: list[Continent]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Continent.from_dict(results_item_data)
        ...
        paginated_continent_list.additional_properties = d
        return paginated_continent_list
