...
T = TypeVar("T", bound="CouponsRetrieveResponse404")


@_attrs_define
class CouponsRetrieveResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_retrieve_response_404 = cls(
            detail=detail,
        ...
        coupons_retrieve_response_404.additional_properties = additional_properties
        return coupons_retrieve_response_404
