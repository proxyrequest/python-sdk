...
T = TypeVar("T", bound="LocationsIspsListResponse401")


@_attrs_define
class LocationsIspsListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        locations_isps_list_response_401 = cls(
            detail=detail,
        ...
        locations_isps_list_response_401.additional_properties = additional_properties
        return locations_isps_list_response_401
