...
T = TypeVar("T", bound="UsersOrdersListResponse401")


@_attrs_define
class UsersOrdersListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_orders_list_response_401 = cls(
            detail=detail,
        ...
        users_orders_list_response_401.additional_properties = additional_properties
        return users_orders_list_response_401
