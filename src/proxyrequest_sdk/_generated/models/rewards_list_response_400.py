...
T = TypeVar("T", bound="RewardsListResponse400")


@_attrs_define
class RewardsListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rewards_list_response_400.additional_properties = additional_properties
        return rewards_list_response_400
