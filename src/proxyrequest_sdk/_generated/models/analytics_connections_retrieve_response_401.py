...
T = TypeVar("T", bound="AnalyticsConnectionsRetrieveResponse401")


@_attrs_define
class AnalyticsConnectionsRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        analytics_connections_retrieve_response_401 = cls(
            detail=detail,
        ...
        analytics_connections_retrieve_response_401.additional_properties = additional_properties
        return analytics_connections_retrieve_response_401
