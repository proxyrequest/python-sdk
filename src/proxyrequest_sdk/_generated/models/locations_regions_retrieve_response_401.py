...
T = TypeVar("T", bound="LocationsRegionsRetrieveResponse401")


@_attrs_define
class LocationsRegionsRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        locations_regions_retrieve_response_401 = cls(
            detail=detail,
        ...
        locations_regions_retrieve_response_401.additional_properties = additional_properties
        return locations_regions_retrieve_response_401
