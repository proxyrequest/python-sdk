...
T = TypeVar("T", bound="ApiKeysDestroyResponse404")


@_attrs_define
class ApiKeysDestroyResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_keys_destroy_response_404 = cls(
            detail=detail,
        ...
        api_keys_destroy_response_404.additional_properties = additional_properties
        return api_keys_destroy_response_404
