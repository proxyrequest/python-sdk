...
T = TypeVar("T", bound="SessionsListResponse403")


@_attrs_define
class SessionsListResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sessions_list_response_403 = cls(
            detail=detail,
        ...
        sessions_list_response_403.additional_properties = additional_properties
        return sessions_list_response_403
