...
T = TypeVar("T", bound="AffiliatesRewardsOverallRetrieveResponse401")


@_attrs_define
class AffiliatesRewardsOverallRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        affiliates_rewards_overall_retrieve_response_401 = cls(
            detail=detail,
        ...
        affiliates_rewards_overall_retrieve_response_401.additional_properties = (
            additional_properties
        )
        return affiliates_rewards_overall_retrieve_response_401
