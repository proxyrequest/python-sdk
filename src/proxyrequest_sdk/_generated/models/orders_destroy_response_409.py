...
T = TypeVar("T", bound="OrdersDestroyResponse409")


@_attrs_define
class OrdersDestroyResponse409:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_destroy_response_409 = cls(
            detail=detail,
        ...
        orders_destroy_response_409.additional_properties = additional_properties
        return orders_destroy_response_409
