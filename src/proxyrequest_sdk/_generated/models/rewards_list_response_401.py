...
T = TypeVar("T", bound="RewardsListResponse401")


@_attrs_define
class RewardsListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rewards_list_response_401.additional_properties = additional_properties
        return rewards_list_response_401
