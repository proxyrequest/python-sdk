...
T = TypeVar("T", bound="ApiKeysListResponse401")


@_attrs_define
class ApiKeysListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        api_keys_list_response_401 = cls(
            detail=detail,
        ...
        api_keys_list_response_401.additional_properties = additional_properties
        return api_keys_list_response_401
