...
T = TypeVar("T", bound="OrdersRetrieveResponse401")


@_attrs_define
class OrdersRetrieveResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_retrieve_response_401 = cls(
            detail=detail,
        ...
        orders_retrieve_response_401.additional_properties = additional_properties
        return orders_retrieve_response_401
