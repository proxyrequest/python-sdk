...
T = TypeVar("T", bound="PaginatedAffiliateRewardList")


@_attrs_define
class PaginatedAffiliateRewardList:
    count: int
    results: list[AffiliateReward]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = AffiliateReward.from_dict(results_item_data)
        ...
        paginated_affiliate_reward_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_affiliate_reward_list.additional_properties = d
        return paginated_affiliate_reward_list
