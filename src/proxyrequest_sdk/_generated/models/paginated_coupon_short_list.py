...
T = TypeVar("T", bound="PaginatedCouponShortList")


@_attrs_define
class PaginatedCouponShortList:
    count: int
    results: list[CouponShort]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = CouponShort.from_dict(results_item_data)
        ...
        paginated_coupon_short_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_coupon_short_list.additional_properties = d
        return paginated_coupon_short_list
