...
T = TypeVar("T", bound="CouponsRedeemsListResponse404")


@_attrs_define
class CouponsRedeemsListResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_redeems_list_response_404 = cls(
            detail=detail,
        ...
        coupons_redeems_list_response_404.additional_properties = additional_properties
        return coupons_redeems_list_response_404
