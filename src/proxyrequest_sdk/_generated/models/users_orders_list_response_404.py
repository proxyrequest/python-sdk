...
T = TypeVar("T", bound="UsersOrdersListResponse404")


@_attrs_define
class UsersOrdersListResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_orders_list_response_404 = cls(
            detail=detail,
        ...
        users_orders_list_response_404.additional_properties = additional_properties
        return users_orders_list_response_404
