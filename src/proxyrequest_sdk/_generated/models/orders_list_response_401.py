...
T = TypeVar("T", bound="OrdersListResponse401")


@_attrs_define
class OrdersListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_list_response_401.additional_properties = additional_properties
        return orders_list_response_401
