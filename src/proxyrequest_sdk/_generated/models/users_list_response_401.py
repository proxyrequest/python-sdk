...
T = TypeVar("T", bound="UsersListResponse401")


@_attrs_define
class UsersListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_list_response_401.additional_properties = additional_properties
        return users_list_response_401
