...
T = TypeVar("T", bound="CouponsCreateResponse403")


@_attrs_define
class CouponsCreateResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        coupons_create_response_403 = cls(
            detail=detail,
        ...
        coupons_create_response_403.additional_properties = additional_properties
        return coupons_create_response_403
