...
T = TypeVar("T", bound="PaginatedCountryList")


@_attrs_define
class PaginatedCountryList:
    count: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Country.from_dict(results_item_data)
        ...
        paginated_country_list.additional_properties = d
        return paginated_country_list
