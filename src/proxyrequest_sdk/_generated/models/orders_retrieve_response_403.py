...
T = TypeVar("T", bound="OrdersRetrieveResponse403")


@_attrs_define
class OrdersRetrieveResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_retrieve_response_403 = cls(
            detail=detail,
        ...
        orders_retrieve_response_403.additional_properties = additional_properties
        return orders_retrieve_response_403
