...
T = TypeVar("T", bound="PaginatedISPList")


@_attrs_define
class PaginatedISPList:
    count: int
    results: list[ISP]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = ISP.from_dict(results_item_data)
        ...
        paginated_isp_list.additional_properties = d
        return paginated_isp_list
