...
T = TypeVar("T", bound="IntegrationsTelegramConnectionDestroyResponse401")


@_attrs_define
class IntegrationsTelegramConnectionDestroyResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integrations_telegram_connection_destroy_response_401 = cls(
            detail=detail,
        ...
        integrations_telegram_connection_destroy_response_401.additional_properties = (
            additional_properties
        )
        return integrations_telegram_connection_destroy_response_401
