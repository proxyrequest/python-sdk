...
T = TypeVar("T", bound="InvoicesCreateResponse401")


@_attrs_define
class InvoicesCreateResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        invoices_create_response_401 = cls(
            detail=detail,
        ...
        invoices_create_response_401.additional_properties = additional_properties
        return invoices_create_response_401
