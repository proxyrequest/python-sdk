...
T = TypeVar("T", bound="AffiliatesRewardsOverallRetrieveResponse400")


@_attrs_define
class AffiliatesRewardsOverallRetrieveResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        affiliates_rewards_overall_retrieve_response_400 = cls(
            detail=detail,
        ...
        affiliates_rewards_overall_retrieve_response_400.additional_properties = (
            additional_properties
        )
        return affiliates_rewards_overall_retrieve_response_400
