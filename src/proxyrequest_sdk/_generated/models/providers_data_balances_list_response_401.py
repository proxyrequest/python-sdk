...
T = TypeVar("T", bound="ProvidersDataBalancesListResponse401")


@_attrs_define
class ProvidersDataBalancesListResponse401:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        providers_data_balances_list_response_401 = cls(
            detail=detail,
        ...
        providers_data_balances_list_response_401.additional_properties = additional_properties
        return providers_data_balances_list_response_401
