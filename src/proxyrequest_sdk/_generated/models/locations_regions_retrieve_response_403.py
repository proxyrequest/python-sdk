...
T = TypeVar("T", bound="LocationsRegionsRetrieveResponse403")


@_attrs_define
class LocationsRegionsRetrieveResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        locations_regions_retrieve_response_403 = cls(
            detail=detail,
        ...
        locations_regions_retrieve_response_403.additional_properties = additional_properties
        return locations_regions_retrieve_response_403
