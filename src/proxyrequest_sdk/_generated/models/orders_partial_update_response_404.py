...
T = TypeVar("T", bound="OrdersPartialUpdateResponse404")


@_attrs_define
class OrdersPartialUpdateResponse404:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        orders_partial_update_response_404 = cls(
            detail=detail,
        ...
        orders_partial_update_response_404.additional_properties = additional_properties
        return orders_partial_update_response_404
