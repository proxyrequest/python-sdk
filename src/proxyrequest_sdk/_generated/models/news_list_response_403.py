...
T = TypeVar("T", bound="NewsListResponse403")


@_attrs_define
class NewsListResponse403:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        news_list_response_403.additional_properties = additional_properties
        return news_list_response_403
